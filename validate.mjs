...
const files = ['data/core/basics.js','data/core/survival.js','data/core/stories.js','data/core/academy1.js','data/core/academy2.js','data/core/analyses.js','data/sales/part1.js','data/sales/part2.js','data/sales/part3.js','data/sales/part4.js','data/sales/part5.js','data/sales/part6.js','data/sales/part7.js','data/sales/situations.js','data/sales/culture.js','data/daily/dailySituations.js','data/train/trainers.js'];
