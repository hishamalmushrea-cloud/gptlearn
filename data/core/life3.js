...
{id:"rel-16",a:"استغفر الله — عدة التسبيح",i:"Astaghfirullah",it:"أستغفرالله",t:"Estağfurullah",tt:"إستاݢفورلله",lv:4,p:3,w:"تعبير يومي حي.",n:"التركية تلفظها «إستا�'فورلله» وتستعملها يوميًا حتى للتأدب في الاعتذار — أصل عربي بروح تركية."},
